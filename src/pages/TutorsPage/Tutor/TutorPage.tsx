            ...
            <div className="space-y-2">
              ...
              <div className="text-sm">
                <p className={infoStyle}>
                  ...
                  <span className={cn("hover:bg-orange-200", badgeStyle)}>
                    {profile.ssid}
                  </span>
                </p>
                <p className={infoStyle}>
                  <Mail className="size-6" />
                  <span className={cn("hover:bg-fuchsia-300", badgeStyle)}>
                    {profile.email}
                  </span>
                </p>
                <p className={infoStyle}>
                  <CakeIcon />
                  <span className={cn("hover:bg-emerald-200", badgeStyle)}>
                    {profile.dob}
                  </span>
                </p>
                <p className={infoStyle}>
                  <Phone />
                  <span className={cn("hover:bg-blue-200", badgeStyle)}>
                    {profile.phoneNumber}
                  </span>
                </p>
                <p className={infoStyle}>
                  <MapPin />
                  <span className={cn("hover:bg-amber-200", badgeStyle)}>
                    {profile.address}
                  </span>
                </p>
              </div>
        ...
        <div className="grow">
          ...
          >
            <div className="flex flex-col gap-4 lg:flex-row">
              ...
              <Button
                className="w-fit bg-t_secondary-300 hover:bg-t_secondary-300/60"
                onClick={() => {
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              ...
              {/* <Badge className="">Geography - Intermediate</Badge>
              <Badge className="">Geography - Intermediate</Badge>
              <Badge className="">Geography - Intermediate</Badge> */}
            </div>
          </SectionLayout>
